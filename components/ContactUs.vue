<template>
  <div class="md:container my-16 sm:my-[120px]">
    <div
      class="bg-[url(~/assets/images/hero-bg.png)] bg-no-repeat bg-cover bg-top rounded-3xl"
    >
      <div class="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_776px] relative">
        <div
          class="flex flex-col gap-6 sm:gap-10 p-4 xl:py-16 xl:pl-16 w-full flex-shrink-0"
        >
          ...
          <VForm @submit="sendConsultationForm" v-slot="{ errors }">
            <div class="grid gap-6">
              <div class="grid gap-2 relative">
                <VField name="name" rules="required" v-model="form.name">
                  <Input
                    ...
                    :class="{
                      '!border-destructive !bg-destructive/5': errors.name,
                    }"
                  />
                </VField>
              </div>
                ...
                <VField name="phone" rules="required" v-model="form.phone">
                  <div class="relative">
                    <Input
                      ...
                      :class="{
                        '!border-destructive !bg-destructive/5': errors.phone,
                      }"
                    />
                    <span
                      class="absolute start-0 inset-y-0 flex items-center justify-center text-white"
                      >+998</span
                    >
                  </div>
                </VField>
              ...
              >
                <p
                  class="text-sm sm:text-base sm:max-w-[280px] text-white flex-1"
                >
                  {{
                    translations[
                      "form.By submitting your request, you agree to the privacy policy"
                    ]
                  }}
                </p>
                <Button
          ...
          <div
            class="flex items-start flex-wrap justify-between gap-6 text-white"
          >
