        ...
        <DialogHeader>
          <DialogTitle class="text-2xl flex items-center justify-between">
            ...
            <DialogClose>
              ...
              >
                <path
                  d="M27.0708 12.9288L12.9287 27.0709M27.0708 27.0708L12.9287 12.9287"
                  stroke="#020105"
                  stroke-width="2"
              ...
              <div class="grid gap-2 relative">
                <VField name="staff" rules="required" v-model="form.staff">
                  <Input
                    ...
                    class="border-0 border-b rounded-none py-3 px-0 placeholder:text-grey-1"
                    :class="{
                      '!border-destructive !bg-destructive/5': errors.staff,
                    }"
                  />
                </VField>
              </div>
              ...
              <div class="grid gap-2 relative">
                <VField name="phone" rules="required" v-model="form.phone">
                  <div class="relative">
                    ...
                    />
                    <span
                      class="absolute start-0 inset-y-0 flex items-center justify-center text-black"
                      >+998</span
                    >
                  </div>
                </VField>
              ...
              <div class="grid gap-2 relative">
                ...
                >
                  <Input
                    ...
                    class="border-0 border-b rounded-none py-3 px-0 placeholder:text-grey-1"
                    :class="{
                      '!border-destructive !bg-destructive/5': errors.email,
                    }"
                  />
                </VField>
              </div>
